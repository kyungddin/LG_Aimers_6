...
from sklearn.tree import DecisionTreeClassifier  # 기본 약한 분류기로 사용

# AdaBoostClassifier 모델 초기화 (base_estimator는 기본값으로 DecisionTreeClassifier)
...
# 결과를 CSV 파일로 저장
sample_submission.to_csv('./adaBoost_250208.csv', index=False)