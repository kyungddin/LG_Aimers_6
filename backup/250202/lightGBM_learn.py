...
# 단순히 범주 데이터를 정수화하고 결측치를 0으로 처리한 것을 확인 가능
# 이러한 데이터 전처리에 대한 개선 필요!!


# 1. feature를 적절히 select할 필요
# 2. 결측치(Nan)을 어떻게 처리할지 논의 필요
# 3. 기타 등등~
...
sample_submission.to_csv('./baseline_submit_250202_5.csv', index=False)
